...
const commands = {
	"add": () => import("./add-B0MVsA9i.mjs").then(_rDefault),
	...
	"_dev": () => import("./dev-child-p35P2N1v.mjs").then(_rDefault),
	"dev": () => import("./dev-hOAvHAa0.mjs").then(_rDefault),
	"devtools": () => import("./devtools-CZX57RQ1.mjs").then(_rDefault),
	"generate": () => import("./generate-5yvIxsSp.mjs").then(_rDefault),
	"info": () => import("./info-Kcq9oj5K.mjs").then(_rDefault),
	"init": () => import("./init-B-3S0azK.mjs").then(_rDefault),
	"module": () => import("./module-C4wJeInS.mjs").then(_rDefault),
	...
	"typecheck": () => import("./typecheck-Bs75hta6.mjs").then(_rDefault),
